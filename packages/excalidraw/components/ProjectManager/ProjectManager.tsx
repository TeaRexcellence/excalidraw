      ...
      try {
        ...
        app.syncActionResult({
          ...
          appState: {
            ...
            name,
            viewBackgroundColor: app.state.viewBackgroundColor,
            scrollX: app.state.width / 2 / (app.state.zoom?.value || 1),
            scrollY: app.state.height / 2 / (app.state.zoom?.value || 1),
          },
        ...
        if (isCurrentProject) {
          ...
          app.syncActionResult({
            ...
            appState: {
              ...
              axesEnabled: app.state.axesEnabled,
              axisLineOpacity: app.state.axisLineOpacity,
              axisLabelOpacity: app.state.axisLabelOpacity,
              axisLineEnabled: app.state.axisLineEnabled,
              axisLabelEnabled: app.state.axisLabelEnabled,
              viewBackgroundColor: app.state.viewBackgroundColor,
              name: "",
            },
            replaceFiles: true,
